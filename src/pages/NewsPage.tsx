            ...
            <div key={item._id} className="bg-gray-900 border border-gray-800 rounded-2xl p-4 flex items-center gap-4">
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="flex items-center gap-2 mt-2">
                  <span className="bg-[#8b1a2f]/40 text-[#c0394f] text-xs px-2 py-0.5 rounded-full">
                    {item.category}
                  </span>
              ...
              <div className="flex items-center gap-2">
                ...
                <button
                  ...
                  className="w-9 h-9 bg-gray-800 hover:bg-[#8b1a2f]/40 text-gray-400 hover:text-[#c0394f] rounded-xl flex items-center justify-center transition-colors"
                >
                  <Trash2 size={15} />
                </button>
              </div>
